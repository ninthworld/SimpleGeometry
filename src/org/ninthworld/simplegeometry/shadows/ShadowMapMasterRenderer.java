...
public class ShadowMapMasterRenderer {
    ...
    private ShadowMapTerrainRenderer terrainSMRenderer;
	 ...
	 */
	public ShadowMapMasterRenderer(Camera camera, TerrainRenderer terrainRenderer) {
		shader = new ShadowShader();
		shadowBox = new ShadowBox(lightViewMatrix, camera);
		shadowFbo = new ShadowFrameBuffer(SHADOW_MAP_SIZE, SHADOW_MAP_SIZE);
		entityRenderer = new ShadowMapEntityRenderer(shader, projectionViewMatrix);
        terrainSMRenderer = new ShadowMapTerrainRenderer(terrainRenderer, shader, projectionViewMatrix);
	}
